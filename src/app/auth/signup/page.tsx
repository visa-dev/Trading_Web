      ...
      if (avatarFile) {
        try {
          ...
          if (uploadResponse.ok) {
            ...
            // If upload fails, continue without profile photo (make it optional)
            console.warn("Profile photo upload failed, continuing without photo")
            const uploadError = await uploadResponse.json().catch(() => ({}))
            toast.warning(uploadError?.error ?? "Profile photo upload failed. Account will be created without photo.")
          }
        } catch (uploadError) {
          // If upload throws an error, continue without profile photo
          console.warn("Profile photo upload error:", uploadError)
          toast.warning("Profile photo upload failed. Account will be created without photo.")
        }
      }
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
                    <Label className="text-white">
                      Profile Image <span className="text-gray-500 text-xs font-normal">(Optional)</span>
                    </Label>
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1 space-y-2">
                        ...
                        <p className="text-xs text-gray-400">
                          Upload a square image (recommended 400x400). You can crop after selecting. Profile photo is optional.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <label htmlFor="terms" className="text-sm text-gray-400">
                      I agree to the <span className="text-yellow-400">Terms of Service</span> and{" "}
